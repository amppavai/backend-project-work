...
public class TraillogApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User user = userRepository
				.save(new User("user", "$2a$10$3Eh3B/tjJKqw4DTcK3Z60.um7/X.XAWXrTjvqaXFd7d8lKI0vTGhq", "USER"));
		// Username: admin, password: admin
		User admin = userRepository
				.save(new User("admin", "$2a$10$iLDK8wfiXUmiCVjtgjtusOz4EMhOritRyFIpnvlsKWAx3rSNAXvBq", "ADMIN"));
		// Username: nomad92, password nomad92
		User nomad92 = userRepository
				.save(new User("nomad92", "$2a$10$YWGMiJPw7Yicwf2RGXXbIO6qFsQb3HU9XtLVVHcchz5X11iGXHWs.", "USER"));
		// Username: seikkailija, password seikkailija
		User seikkailija = userRepository
				.save(new User("seikkailija", "$2a$10$ggbGXyoWETAIk/pb09qBWePWGvLLyiBnfmTs/xJ7WWPt6Q8NcGvdu", "USER"));
		// Username: mirkku1965, password mirkku1965
		User mirkku1965 = userRepository
				.save(new User("mirkku1965", "$2a$10$KI8IEdONoU0PVZCRzni6FOoRbDDnVcgDRtYJTQDl1PeKLUsJiLVuO", "USER"));

		log.info("Lisätään kohteita tietokantaan");
		Destination japani = destinationRepository
				.save(new Destination("Japani", "Temppeleitä, kirsikankukkia, sushia", 4.7));
		Destination australia = destinationRepository
				.save(new Destination("Australia", "Rantoja, kenguruja, aavikkoa", 4.2));
		Destination uusiseelanti = destinationRepository
				.save(new Destination("Uusi-Seelanti", "Vuoria, järviä, lampaita", 4.5));
		...
		Destination marokko = destinationRepository
				.save(new Destination("Marokko", "Aavikkoa, rantaa, vuoristoa", 4.2));
		...
		// Tallenna käyttäjät uudelleen, jotta kohteiden muutokset tallentuvat
		// tietokantaan
